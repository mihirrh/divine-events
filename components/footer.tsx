...
const footerLinks = {
  services: [
    { name: "Mandap Hire", href: "/services/mandap-hire" },
    { name: "Wedding Decor", href: "/services/wedding-decor" },
    { name: "Stage Design", href: "/services/stage-design" },
    { name: "DJ Entertainment", href: "/services/dj-entertainment" },
    { name: "Lighting Production", href: "/services/lighting" },
    { name: "Complete Packages", href: "/services/packages" },
  ],
  locations: [
    ...
    { name: "Derby", href: "/locations/derby" },
      ...
      <div className="container-luxury">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <h3 className="text-3xl font-display font-bold text-luxury-gold">
              Divine Events
            </h3>
            <p className="text-luxury-cream/80 leading-relaxed">
              Creating unforgettable luxury Asian wedding experiences across the UK. 
              From bespoke mandaps to complete event production.
            </p>
            <div className="space-y-3">
              <a
                href="tel:+441234567890"
                className="flex items-center space-x-3 text-luxury-cream/80 hover:text-luxury-gold transition-colors"
              >
              ...
              >
                ...
                <span>info@divineevents.co.uk</span>
              </a>
          ...
          {/* Services */}
          <div>
            <h4 className="text-xl font-display font-semibold text-luxury-gold mb-6">
              Services
            </h4>
        ...
        <div className="border-t border-luxury-gold/20 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-luxury-cream/60 text-sm">
              © {new Date().getFullYear()} Divine Events. All rights reserved.
            </p>
